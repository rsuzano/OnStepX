...
#define AXIS1_DRIVER_MODEL            DRV8825 //    OFF, Enter motor driver model (above) in both axes to activate the mount.    <-Often
#define TMC_IRUN 1300
#define TMC_IGOTO 1300
...
#define AXIS2_DRIVER_MODEL            DRV8825 //    OFF, Enter motor driver model (above) in both axes to activate the mount.    <-Often
...
#define AXIS2_DRIVER_DECAY            STEALTHCHOP //STEALTHCHOP //    OFF, Tracking decay mode default override. TMC default is STEALTHCHOP.        Infreq
...
#define SLEW_RATE_BASE_DESIRED        3 //2.65 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS4_LIMIT_MAX                400 //     50, n. Where n=0..500 (millimeters.) Maximum allowed position.               Adjust
